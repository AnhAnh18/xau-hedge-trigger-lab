"""Run the owner-authorized E-002 aggregate-only capture."""
...
from xau_trigger.retro_live_evidence_002_capture import capture_authorized
from xau_trigger.retro_live_evidence_002_receipt import validate_source_receipt


def main() -> int:
    try:
        receipt = parse_unique_json(sys.stdin.read())
        ...
        return 0
    except (RetroBotInputError, TypeError, ValueError, KeyError, OSError):
        sys.stderr.write("E-002 authorized capture rejected\n")
        return 2
