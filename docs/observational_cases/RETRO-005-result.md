# RETRO-005 Result: Historical One-Leg Case

Status: descriptive result; independent review PASS; RETRO-005 complete.
...
Aggregate result digest: `a3d8a666de7c465db3473d2cdf60575b11a1cd5a9027d468d361f8854de03520`.
The source objects remain quarantine-only and are not M5 inputs.

## Observed

- The preselected `2026-03-03` `buy` one-leg interval
  is uniquely reconstructed for `3793` seconds, with
...
- The selected window contains `4` order rows and
