# RETRO-006: Historical One-Leg Case
...
- Server interval: inclusive `2026-07-01 01:27:55` through
  `2026-07-01 01:41:15`.
- Selected target date: `2026-07-01`; selected side:
  `buy`; inventory duration band: `300_to_900_seconds`.
- Report alias: `report-009.html`.
- Tick alias: `XAUUSD_ticks_2026-06-27_to_2026-07-04.csv`.
