# RETRO-004 Result: Historical One-Leg Case

Status: descriptive result; independent review PASS; RETRO-004 complete.
...
Aggregate result digest: `19bd513190f92f682c82ea6ccaffa927c6e4032a31c8065f71c9560a04f9fb07`.
The source objects remain quarantine-only and are not M5 inputs.

## Observed

- The preselected `2025-11-12` `sell` one-leg interval
  is uniquely reconstructed for `329` seconds, with
...
- The selected window contains `2` order rows and
