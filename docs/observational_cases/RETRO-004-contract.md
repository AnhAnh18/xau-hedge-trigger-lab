# RETRO-004: Historical One-Leg Case
...
- Server interval: inclusive `2025-11-12 22:22:01` through
  `2025-11-12 22:31:30`.
- Selected target date: `2025-11-12`; selected side:
  `sell`; inventory duration band: `300_to_900_seconds`.
- Report alias: `report-001.html`.
- Tick alias: `XAUUSD_ticks_2025-11-08_to_2025-11-15.csv`.
